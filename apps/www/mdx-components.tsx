...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h2: (props) => (
      <h2
        className="text-xl font-semibold tracking-tight text-neutral-900 dark:text-neutral-100 mt-12 mb-3"
        {...props}
      />
    ),
    h3: (props) => (
      <h3
        className="text-base font-semibold text-neutral-900 dark:text-neutral-100 mt-8 mb-2"
        {...props}
      />
    ),
    p: (props) => (
      <p
        className="text-[15px] leading-7 text-neutral-700 dark:text-neutral-300 my-4 text-pretty"
        {...props}
      />
    ),
    ul: (props) => (
      <ul
        className="list-disc pl-6 my-4 space-y-1 text-[15px] text-neutral-700 dark:text-neutral-300"
        {...props}
      />
    ),
    ol: (props) => (
      <ol
        className="list-decimal pl-6 my-4 space-y-1 text-[15px] text-neutral-700 dark:text-neutral-300"
        {...props}
      />
    ),
    ...
    td: (props) => (
      <td
        className="px-3 py-2 text-neutral-700 dark:text-neutral-300 border-b border-neutral-100 dark:border-neutral-900 last:border-b-0 align-top"
        {...props}
      />
    ),
    ...
    code: ({ children, className, ...rest }: CodeProps) => (
      <code
        className={`${className ?? ""} rounded bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 text-[0.9em] font-mono text-neutral-900 dark:text-neutral-100`}
        {...rest}
      >
