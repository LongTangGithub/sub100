...
function OptimisticDemo() {
    ...
    const label = optimisticState === "saving" ? "Saving…" : status === "saved" ? "Saved" : status === "error" ? "Failed — retry" : "Save";
    const labels = ["Save", "Saving…", "Saved", "Failed — retry"] as const;

    return (
        <div className="flex flex-col gap-2">
            <p className="text-sm text-neutral-500">Optimistic action — fails ~30% of the time</p>
            <Button
    ...
    return (
        <main className="min-h-screen p-12 flex flex-col gap-12 max-w-2xl">
            <div>
                ...
                <p className="text-sm text-neutral-500">Press fires on pointerdown. Transforms commit in &lt;16ms.</p>
            </div>

            <section className="flex flex-col gap-4">
                <h2 className="text-sm font-medium text-neutral-400 uppercase tracking-wider">Variants</h2>
            ...
            <section className="flex flex-col gap-4">
                <h2 className="text-sm font-medium text-neutral-400 uppercase tracking-wider">Sizes</h2>
            ...
            <section className="flex flex-col gap-4">
                <h2 className="text-sm font-medium text-neutral-400 uppercase tracking-wider">States</h2>
                <div className="flex flex-wrap gap-3">
            ...
            <section className="flex flex-col gap-4">
                <h2 className="text-sm font-medium text-neutral-400 uppercase tracking-wider">Optimistic action</h2>
                <OptimisticDemo />
            </section>
        </main>
    );
